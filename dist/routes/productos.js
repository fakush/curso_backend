...
const router = _express.default.Router(); // Lógica Aux
...
router.get('/vista/:id', (req, res) => {
  ...
  const searchItem = myArray.find(itemId => itemId.id === id);
...
router.post('/guardar', (req, res) => {
  ...
  if (!body.title || typeof body.title !== 'string' || !body.price || typeof Number(body.price) !== 'number' || !body.thumbnail || typeof body.thumbnail !== 'string') {
...
router.put('/actualizar/:id', (req, res) => {
  ...
  myArray[index].price = body.price;
